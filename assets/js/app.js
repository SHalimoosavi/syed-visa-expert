...
class SayanjaliApp {
    ...
    setupIntersectionObserver() {
        ...
        // Observe cards
        document.querySelectorAll('.help-card, .choose-card, .article-card, .expertise-card, .faq-item').forEach(card => {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('a[href*="wa.me"]').forEach(link => {
        link.addEventListener('click', Analytics.trackWhatsAppClick);
    });
    ...
    console.log('SAYANJALI NEXUS - Application initialized');
});
